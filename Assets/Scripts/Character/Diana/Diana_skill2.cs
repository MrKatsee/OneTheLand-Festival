...
public class Diana_skill2 : MonoBehaviour {
	...
	public void skill2()
	{
		...
		bullet_skill2 = Instantiate(Bullet_Mana,bulletShootPosition + gameObject.transform.position,Quaternion.identity);
		bullet_skill2.transform.parent = GameObject.Find("BulletManager").transform;
		//bullet_skill2.GetComponent<Rigidbody2D>().velocity = bullet_skill2.GetComponent<BulletIdentifier>().bulletSpd*direction; 수정할 것 멈추게 할려고
